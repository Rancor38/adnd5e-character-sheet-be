...
from character_sheets.views import CharacterSheetCreateView, CharacterSheetDeleteView, CharacterSheetUpdateView
...
urlpatterns = [
    ...
    path('api/character_sheets/<int:pk>/', CharacterSheetUpdateView.as_view(), name='character_sheet_update'),
]
